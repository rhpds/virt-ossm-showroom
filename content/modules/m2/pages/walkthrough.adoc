...
NOTE: It is also possible to autoscale Virtual Machines by using a HorizontalPodAutoscaler (HPA) with a VirtualMachinePool.
...
You should see 8 additional VMs spinning up...
